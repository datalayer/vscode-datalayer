...
class MinimalKernelManager {
  ...
  async startNew(
    ...
    console.log(
      "[MinimalKernelManager] Creating inline Pyodide kernel with Blob URL worker...",
    );
    ...
    console.log("[MinimalKernelManager] Inline Pyodide kernel created!");
  ...
  async connectTo(
    ...
    console.log(
      "[MinimalKernelManager] connectTo called, returning existing kernel",
    );
  ...
  async refreshRunning(): Promise<void> {
    ...
    console.log("[MinimalKernelManager] refreshRunning (no-op)");
  }

  async shutdown(id: string): Promise<void> {
    console.log("[MinimalKernelManager] shutdown kernel:", id);
  ...
  async shutdownAll(): Promise<void> {
    console.log("[MinimalKernelManager] shutdownAll");
    if (this._pyodideKernel) {
      this._pyodideKernel.dispose();
      this._pyodideKernel = null;
    }
...
class MinimalSessionManager {
  ...
  async startNew(
    ...
    console.log("[MinimalSessionManager] startNew session");
  ...
  async connectTo(
    ...
    console.log("[MinimalSessionManager] connectTo session");
  ...
  async refreshRunning(): Promise<void> {
    // No-op
    console.log("[MinimalSessionManager] refreshRunning (no-op)");
  }
  ...
  async shutdown(id: string): Promise<void> {
    console.log("[MinimalSessionManager] shutdown session:", id);
  }

  async shutdownAll(): Promise<void> {
    console.log("[MinimalSessionManager] shutdownAll");
  }
}
...
export async function createPyodideMinimalServiceManager(): Promise<ServiceManager.IManager> {
  console.log(
    "[PyodideMinimalServiceManager] Creating minimal service manager...",
  );
  ...
  console.log("[PyodideMinimalServiceManager] Service manager ready!");
