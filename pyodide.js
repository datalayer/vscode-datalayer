!(function (global, factory) {
  ...
  let loadScript;
  if (globalThis.document) loadScript = (url) => import(url);
    ...
    (Module.pyproxy_new = function (ptrobj, cache) {
      ...
      (cache.refcnt++,
        Object.defineProperty(target, "$$", {
          value: { ptr: ptrobj, type: "PyProxy", borrowed: !1, cache: cache },
        }),
  ...
  class PyProxyIteratorMethods {
    ...
    next(arg) {
      ...
      return (
        ...
        { done: done, value: Module.hiwire.pop_value(idresult) }
      );
    }
  }
  let PyProxyHandlers = {
...
fetch("https://cdn.jsdelivr.net/pyodide/v0.18.1/full/pyodide.js").then(
  async (pyodideScript) => {
    var text = await pyodideScript.text();
    self.eval(trustedTypesPolicy.createScript(text));
  },
);
var indexURL = "https://cdn.jsdelivr.net/pyodide/v0.18.1/full/";
var _widgetsnbextensionWheelUrl =
  "https://cdn.jsdelivr.net/gh/joyceerhltest/vscode-pyodide@1dde45c789638b19719887b5c01bbd5136aeae6b/src/web/wheels/widgetsnbextension-3.5.0-py3-none-any.whl";
var _nbformatWheelUrl =
  "https://cdn.jsdelivr.net/gh/joyceerhltest/vscode-pyodide@1dde45c789638b19719887b5c01bbd5136aeae6b/src/web/wheels/nbformat-4.2.0-py3-none-any.whl";
var _ipykernelWheelUrl =
  "https://cdn.jsdelivr.net/gh/joyceerhltest/vscode-pyodide@1dde45c789638b19719887b5c01bbd5136aeae6b/src/web/wheels/ipykernel-5.5.5-py3-none-any.whl";
var _pyoliteWheelUrl =
  "https://cdn.jsdelivr.net/gh/joyceerhltest/vscode-pyodide@1dde45c789638b19719887b5c01bbd5136aeae6b/src/web/wheels/pyolite-0.1.0a9-py3-none-any.whl";
var __awaiter =
  (this && this.__awaiter) ||
...
function loadPyodideAndPackages() {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    pyodide = yield loadPyodide({ indexURL });
