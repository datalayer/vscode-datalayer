...
/**
 * Generates the HTML content for the datasource edit dialog webview with Primer theme CSS and CSP.
 ...
 *
 * @returns Complete HTML string for the edit dialog webview.
 */
